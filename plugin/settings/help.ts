...
export function help(settings: GitHubPublisherSettings) {
	...
	explanation.createEl("ul", null, (span) => {
		span.createEl("li", null, (span) => {
			span.createEl("code", { text: `${settings.shareKey}:`, cls: "code-title" });
			span.createEl("span", {
		...
		span.createEl("ul", null, (l) => {
			l.createEl("li", null, (p) => {
				...
				p.createEl("span", {text: `: ${subSettings("help.frontmatter.mdlinks") as string}`})
			});
			l.createEl("li", null, (p) => {
				p.createEl("code", {text: 'convert'})
				p.createEl("span", null, (span) => {
					span.createEl("span", {text: `: ${subSettings("help.frontmatter.convert.enableOrDisable") as string} `})
					span.createEl("code", {text: ' [[link]] '})
					span.createEl("span", {text: subSettings("help.frontmatter.convert.or") as string})
					span.createEl("code", {text: ' [](link) '})
					span.createEl("span", {text: subSettings("help.frontmatter.convert.syntax") as string})
				});
			});
		});
		...
		span.createEl("ul", null, (l) => {
			l.createEl("li", null, (p) => {
				...
				p.createEl("span", {text: `: ${subSettings('help.frontmatter.embed.send') as string}`})
			});
			l.createEl("li", null, (p) => {
				p.createEl("code", {text: 'remove'})
				p.createEl("span", {text: `: ${subSettings('help.frontmatter.embed.remove') as string}`})
			});
		});
		...
		span.createEl("ul", null, (l) => {
			...
			l.createEl("li", null, (p) => {
				...
				p.createEl("span", {text: `: ${subSettings('help.frontmatter.attachment.folder') as string}`})
			});
		});
		span.createEl("li", null, (span) => {
			span.createEl("code", { text: "dataview", cls: "code-title"});
			span.createEl("span", { text: `: ${subSettings('help.frontmatter.dataview') as string}` });
		});
		span.createEl("li", null, (span) => {
			span.createEl("code", { text: "hardbreak", cls: "code-title"});
			span.createEl("span", { text: `: ${subSettings('help.frontmatter.hardBreak') as string}` });
		});
		span.createEl("li", null, (span) => {
			span.createEl("code", { text: "repo", cls: "code-title"  })
			span.createEl("span", { text: `: ${subSettings('help.frontmatter.repo.desc')}` });
		...
		span.createEl("li", null, (span) => {
			span.createEl("code", { text: `${settings.frontmatterTitleKey}`, cls: "code-title" });
			span.createEl("span", { text: `: ${subSettings('help.frontmatter.titleKey')}` });
		});
		span.createEl("li", null, (span) => {
			span.createEl("code", { text: "autoclean", cls: "code-title" });
			span.createEl("span", { text: `: ${subSettings("help.frontmatter.autoclean")}` });
		});
		span.createEl("li", null, (span) => {
			span.createEl("code", { text: "baseLink", cls: "code-title" });
			span.createEl("span", { text: `: ${subSettings("help.frontmatter.baselink")}` });
		});
	});
	return explanation;
}
...
export function usefullLinks(): DocumentFragment {
	...
	usefullLinks.createEl('ul', null, (el) => {
		el.createEl('li', null, (el) => {
			el.createEl('a', {text: subSettings('help.usefulLinks.documentation') as string, href: subSettings('help.usefulLinks.links') as string})
		});
		el.createEl('li', null, (el) => {
			el.createEl('a', {text: subSettings('help.usefulLinks.repository') as string, href: 'https://github.com/ObsidianPublisher/obsidian-github-publisher'})
		})
		el.createEl('li', null, (el) => {
			el.createEl('a', {text: subSettings('help.usefulLinks.issue') as string, href: 'https://github.com/ObsidianPublisher/obsidian-github-publisher/issues'})
		})
		el.createEl('li', null, (el) => {
			el.createEl('a', {text: subSettings('help.usefulLinks.discussion') as string, href: 'https://github.com/ObsidianPublisher/obsidian-github-publisher/discussions'})
		});
	});
	return usefullLinks;
}
...
export function multipleRepoExplained(settings: GitHubPublisherSettings): DocumentFragment {
	...
	multipleRepoExplained.createEl('p', null, (el) => {
		el.createEl('span', {text: subSettings('help.multiRepoHelp.desc') as string})
		el.createEl('code', {text: "multipleRepo"})
		el.createEl('span', {text: ` ${subSettings('help.multiRepoHelp.desc2') as string}:`})
		...
		el.createEl('span', {text: subSettings('help.multiRepoHelp.exampleDesc') as string})
	})
	multipleRepoExplained.createEl('pre', {cls: 'language-yaml'})
		.createEl('code', {text: `multipleRepo:\n  - owner: ${settings.githubName}\n    repo: ${settings.githubRepo}\n    branch: ${settings.githubBranch}\n  - owner: ${settings.githubName}\n    repo: my_second_brain\n    branch: master`, cls: 'language-yaml'})
